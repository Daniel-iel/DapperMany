...
/// using PostgreSQL via centralized PostgreSqlDatabaseFixture.
/// Tests composite key patterns for multi-tenant scenarios with primary keys on multiple columns.
/// PostgreSQL requires quoted identifiers to preserve case sensitivity.
/// </summary>
public class CompositeKeyIntegrationTests : IClassFixture<PostgreSqlDatabaseFixture>
{
    private readonly PostgreSqlDatabaseFixture _fixture;

    public CompositeKeyIntegrationTests(PostgreSqlDatabaseFixture fixture)
    {
        _fixture = fixture;
