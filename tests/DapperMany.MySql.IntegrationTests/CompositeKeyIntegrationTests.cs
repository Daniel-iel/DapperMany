...
/// using MySQL via centralized MySqlDatabaseFixture.
/// Tests composite key patterns for multi-tenant scenarios with primary keys on multiple columns.
/// </summary>
public class CompositeKeyIntegrationTests : IClassFixture<MySqlDatabaseFixture>
{
    private readonly MySqlDatabaseFixture _fixture;

    public CompositeKeyIntegrationTests(MySqlDatabaseFixture fixture)
    {
        _fixture = fixture;
