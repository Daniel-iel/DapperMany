  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          html: "<code>InsertManyAsync</code> detecta automaticamente as relações. Se o tipo de entidade tem atributos <code>[HasMany]</code> ou <code>[HasOne]</code>, insere pais, popula o Id gerado de volta em cada entidade e propaga a FK para os filhos recursivamente. Do contrário, realiza uma inserção de coleção plana.",
        },
        {
          type: "ol",
          items: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "<code>InsertManyAsync</code> no SQL Server — 1 nível de relacionamento primeiro, recursão depois.",
